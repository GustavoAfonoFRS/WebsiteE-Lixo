...
def send_email(nome, email, assunto, mensagem):
    ...
    # IMPORTANTE: Use uma "Palavra-passe de app" do Google (16 caracteres)
    sender_email = "addhfdgdfdshfdah@gmail.com" # Pode usar o seu gmail aqui
    sender_password = "gbqt xqcp ssxw mlpl" # Coloque aqui a App Password
    ...
    try:
        # Ligar ao servidor SMTP do Gmail
...
if __name__ == "__main__":
    if len(sys.argv) >= 5:
        # Receber dados via argumentos posicionais: nome, email, assunto, mensagem
        try:
            nome = sys.argv[1]
            email = sys.argv[2]
            assunto = sys.argv[3]
