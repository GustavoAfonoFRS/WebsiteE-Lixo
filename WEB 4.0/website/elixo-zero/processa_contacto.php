...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // 2. Enviar Email usando Python (muito mais fiável localmente)
    ...
    // Executa o script python em background no Windows
    $command = "start /B $python_path $script_path $nome_esc $email_esc $assunto_esc $msg_esc";
    pclose(popen($command, "r"));

    // Redireciona imediatamente (a mensagem já está no DB e o envio ocorre em background)
