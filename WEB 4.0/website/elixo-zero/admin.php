    ...
    <div class="container py-lg-4">
        ...
        <?php if (isset($_GET['status'])): ?>
            <div class="alert alert-dark d-flex align-items-center gap-3 mb-5 p-4">
                ...
                <?php
                if ($_GET['status'] == 'sucesso')   echo 'Ponto de recolha guardado com sucesso.';
                if ($_GET['status'] == 'eliminado') echo 'Ponto de recolha removido do sistema.';
                ?>
                </span>
            </div>
        <?php endif; ?>
...
?>
                        <tr>
                            ...
                            <td><span class="badge bg-dark rounded-pill px-3 py-2 fw-semibold" style="font-size: 0.7rem;"><?php echo $row['tipo_residuo']; ?></span></td>
...
?>
                        <tr>
                            <td colspan="4" class="text-center py-5 text-muted small opacity-50">Sem mensagens novas.</td>
                        </tr>
                        <?php
endif;
...
?>
                        <tr>
                            ...
                            <td><span class="small fw-bold opacity-75"><?php echo strtoupper($msg['assunto']); ?></span></td>
                            <td><p class="small text-muted mb-0 text-truncate" style="max-width: 300px;"><?php echo $msg['mensagem']; ?></p></td>
                            <td class="text-end pe-4 small text-muted"><?php echo date('d M, Y', strtotime($msg['data_envio'])); ?></td>
                        </tr>
                        <?php
endwhile; ?>
                    </tbody>
                ...
                <div class="modal-body p-4 p-md-5">
                    <div class="row g-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nome" class="form-control" placeholder="Ex: Ecocentro Monsanto" required>
                        </div>
                        <div class="col-md-6">
                            <label class="fw-bold small text-muted mb-2 px-1">FREGUESIA</label>
                            <select name="freguesia" class="form-select border-0 bg-soft rounded-4 p-3 fw-semibold" required>
...
?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tipo_residuo" class="form-control" placeholder="Pequenos, Grandes, TI..." required>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="modal-footer border-0 p-4">
                    <button type="button" class="btn btn-outline-dark px-4 rounded-pill" data-bs-dismiss="modal">Fechar</button>
