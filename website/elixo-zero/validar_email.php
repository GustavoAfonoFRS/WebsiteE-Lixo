                ...
                <div class="card p-0 shadow-lg border-0 overflow-hidden" style="border-radius: 40px;">
                    <div class="card-body p-4 p-md-5">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted small px-3">Introduza o código de 6 dígitos enviado para
                                <strong><?php echo $email_verificar; ?></strong></p>
                        </div>
                        ...
                        <form action="validar_email.php" method="POST">
                            ...
                            <div class="mb-5">
                                <label class="fw-bold small text-muted mb-2 px-1 text-uppercase">Código de
                                    Verificação</label>
                            ...
                            <div class="text-center mt-5 pt-3 border-top">
                                <p class="small text-muted mb-0">NÃO RECEBEU O CÓDIGO? <br>
                                    <a href="registo.php" class="fw-bold text-dark text-decoration-none">TENTE REGISTAR
                                        NOVAMENTE</a>
                                </p>
                            </div>
                        </form>
