                ...
                <div class="card p-0 shadow-lg border-0 overflow-hidden" style="border-radius: 40px;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="text-center mb-5">
                            <div class="bg-dark d-inline-flex align-items-center justify-content-center mb-4 rounded-circle shadow-sm"
                                style="width: 80px; height: 80px;">
                                <i class="fas fa-user-plus fa-2x text-white"></i>
                            </div>
                            <h1 class="h3 fw-bold mb-3">Criar Conta</h1>
                            <p class="text-muted small px-lg-5">Faça parte da rede de sustentabilidade urbana de Lisboa.
                            </p>
                        </div>
                        ...
                        <form action="processa_registo.php" method="POST">
                            <div class="mb-4">
                                ...
                                <input type="text" name="nome" class="form-control" placeholder="Ex: Maria Silva"
                                    required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="password" name="confirm_password" id="confirm_password"
                                    class="form-control" placeholder="Repita a sua password" required>
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" name="admin_code" class="form-control"
                                    placeholder="Introduza o código se for administrador">
                            </div>

                            <button type="submit" id="submitBtn"
                                class="btn btn-dark btn-lg w-100 py-3 shadow-sm rounded-pill fw-bold">
                                CRIAR CONTA
                            </button>

                            <div class="text-center mt-5 pt-3 border-top">
                                <p class="small text-muted mb-0">JÁ É MEMBRO? <a href="login.php"
                                        class="fw-bold text-dark text-decoration-none">LOGIN</a></p>
                            </div>
                        </form>
                    </div>
                </div>
